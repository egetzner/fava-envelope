...
from envelope_budget.modules.goals.target_types.goal import CustomGoalTargetParser


class TargetFromCustomGoalTests(cmptest.TestCase):
    def test_target_existing(self):
        input_text = textwrap.dedent("""
            ...
            2020-01-01 custom "goal" Assets:EmergencyFund 50 EUR
            2020-01-01 custom "goal" Expenses:Rent "monthly" 1000 EUR
            2020-01-01 custom "goal" Expenses:Holiday 150 EUR "by" 2020-12-15
    ...
    def test_target_new(self):
        input_text = textwrap.dedent("""
            ...
            2020-01-01 custom "goal" Assets:EmergencyFund 5000 EUR
            2020-01-01 custom "goal" Expenses:Rent "monthly" 1000 EUR
            2020-01-01 custom "goal" Expenses:Holiday 150 EUR "by" 2020-12-15
        ...
        targetParser = CustomGoalTargetParser()
